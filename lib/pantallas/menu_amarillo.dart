...
class menu_amarillo extends StatelessWidget {
  const menu_amarillo({super.key});
            ...
            children: [
              Container(
                ...
                child: Padding(
                  ...
                  child: Image(
                    image: const AssetImage("images/nomark_color2.png"),
                    height: 200,
                    width: MediaQuery.of(context).size.width,
                    fit: BoxFit.contain, 
                  ),
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const FinalScreen2()),
                    );
                  },
                  child: const Image(
