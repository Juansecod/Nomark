...
class menu_azul extends StatelessWidget {
  const menu_azul({super.key});
            ...
            children: [
              Container(
                ...
                child: Padding(
                  ...
                  child: Image(
                    image: const AssetImage("images/nomark_color4.png"),
                    height: 200,
                    width: MediaQuery.of(context).size.width,
                    fit: BoxFit.contain, 
                  ),
                ...
                child: Center(
                  child: InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const FinalScreen4()),
                      );
                    },
                    child: const Image(
