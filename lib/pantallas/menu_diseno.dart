...
class menu_diseno extends StatelessWidget {
  const menu_diseno({super.key});
            ...
            children: [
              Container(
                ...
                child: Padding(
                  ...
                  child: Image(
                    image: const AssetImage("images/nomark_mokup1.png"),
                    height: 200,
                    width: MediaQuery.of(context).size.width,
                    fit: BoxFit.contain, 
                  ),
              ...
              Padding(
                padding: const EdgeInsets.fromLTRB(0, 20, 0, 0),
                child: Image(
                  image: const AssetImage("images/bt_continuar.png"),
                  height: 70,
                  width: MediaQuery.of(context).size.width,
                  fit: BoxFit.contain,
                ),
