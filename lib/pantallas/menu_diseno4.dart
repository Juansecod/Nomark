...
class menu_diseno4 extends StatelessWidget {
  const menu_diseno4 ({super.key});
            ...
            children: [
              Container(
                ...
                child: Padding(
                  ...
                  child: Image(
                    image: const AssetImage("images/nomark_mokup-5.png"),
                    height: 200,
                    width: MediaQuery.of(context).size.width,
                    fit: BoxFit.contain, 
                  ),
                ...
                child:  Center(
                  child: InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const FinalScreen10()),
                      );
                    },
                    child: const Image(
